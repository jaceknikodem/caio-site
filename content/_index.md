...
✓ 20+ AI products shipped to 1B+ users<br>
✓ Top 10 innovation at Google (Pixel Recorder AI)<br>
✓ $XXXM revenue impact at DeepMind/YouTube<br>
✓ Built AI teams across US & Asia
...
- Made Pixel **"the smartest phone in the room"** with on-device AI.

- **Top 10 tech innovation at Google:** Pixel Recorder's AI summaries.

- **Empowered >80k engineers** with LLM-based dev tools.
